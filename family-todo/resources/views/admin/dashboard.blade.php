...
<body class="bg-gray-50">
    <div class="flex h-screen bg-gray-100">
        <!-- Sidebar -->
        <div class="sidebar w-64 bg-gradient-to-b from-indigo-600 to-indigo-800 text-white p-0 hidden lg:block fixed h-full left-0 top-0 z-40">
            <!-- Logo -->
            <div class="p-6 border-b border-indigo-500">
                ...
                <p class="text-indigo-300 text-xs mt-1">Family Todo Dashboard</p>
            </div>
            ...
            <nav class="mt-6 flex-1">
                ...
                <a href="{{ route('admin.users') }}" class="nav-item block px-6 py-3 text-indigo-200 hover:text-white">
                    <svg class="w-5 h-5 inline-block mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="{{ route('admin.tasks') }}" class="nav-item block px-6 py-3 text-indigo-200 hover:text-white">
                    <svg class="w-5 h-5 inline-block mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01"></path>
                    </svg>
                    View Tasks
                </a>
                <a href="{{ route('admin.posts') }}" class="nav-item block px-6 py-3 text-indigo-200 hover:text-white">
                    <svg class="w-5 h-5 inline-block mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <!-- Footer -->
            <div class="p-6 border-t border-indigo-500 text-indigo-300 text-xs">
            ...
            <div class="bg-white border-b border-gray-200 p-4 lg:p-6 flex items-center justify-between">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <div class="flex items-center space-x-2 pl-4 border-l border-gray-200">
                        <img class="w-10 h-10 rounded-full" src="https://ui-avatars.com/api/?name={{ auth()->user()->name }}&color=667eea&background=f0f4ff" alt="{{ auth()->user()->name }}">
                ...
                <div class="p-4 lg:p-8">
                    ...
                    <div class="bg-white rounded-xl shadow-sm p-6 mb-8">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <a href="{{ route('admin.users') }}" class="group relative overflow-hidden bg-gradient-to-r from-blue-500 to-blue-600 text-white font-semibold py-4 px-6 rounded-lg transition duration-300 hover:shadow-lg hover:-translate-y-1">
                            ...
                            <a href="{{ route('admin.tasks') }}" class="group relative overflow-hidden bg-gradient-to-r from-green-500 to-green-600 text-white font-semibold py-4 px-6 rounded-lg transition duration-300 hover:shadow-lg hover:-translate-y-1">
                                <span class="relative z-10 flex items-center justify-center">
                                    <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2"></path>
                                    </svg>
                            ...
                            <a href="{{ route('admin.posts') }}" class="group relative overflow-hidden bg-gradient-to-r from-purple-500 to-purple-600 text-white font-semibold py-4 px-6 rounded-lg transition duration-300 hover:shadow-lg hover:-translate-y-1">
                                <span class="relative z-10 flex items-center justify-center">
                                    <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 20H5a2 2 0 01-2-2V6a2 2 0 012-2h10a2 2 0 012 2v1m2 13a2 2 0 01-2-2V7m2 13a2 2 0 002-2V9a2 2 0 00-2-2h-2m-4-3H9M7 16h6M7 8h6v4H7V8z"></path>
                                    </svg>
                    ...
                    <!-- Footer Stats -->
                    <div class="bg-gradient-to-r from-indigo-600 to-indigo-800 rounded-xl text-white p-8">
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                            <div>
                                <p class="text-indigo-200 text-sm font-medium">Active Sessions</p>
                                <p class="text-3xl font-bold mt-2">{{ $usersCount }}</p>
                            </div>
                            <div>
                                <p class="text-indigo-200 text-sm font-medium">System Status</p>
                                <p class="text-3xl font-bold mt-2">✓ Operational</p>
                            </div>
                            <div>
                                <p class="text-indigo-200 text-sm font-medium">Last Update</p>
